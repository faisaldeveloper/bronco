...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
	  <tr>
	    <td align="right"><a href="ManageCategory.php">&lt;&lt;back</a></td>
	    </tr>
	  <tr>
	    <td class="hdng_sandy">Edit Category</td>
	    </tr>
	  <tr>
	    <td><form name="frmCat" id="frmCat" method="post" action="EditCategoryAction.php" onSubmit="return ValidateForm(this);">
	      <table width="50%" border="0" cellspacing="0" cellpadding="2" align="center">
	        <tr>
	          <td align="right">Name:</td>
	          <td><input type="text" name="txtCat" id="txtCat" value="<?=$strCatName?>"></td>
	          </tr>
	        <tr>
	          <td>&nbsp;</td>
	          <td><input name="btnEdit" type="submit" class="button" id="btnEdit" value="Update">
                   <input type="hidden" name="hdnCatId" value="<?=$nCatId?>">
              </td>
	          </tr>
	        <tr>
	          <td>&nbsp;</td>
