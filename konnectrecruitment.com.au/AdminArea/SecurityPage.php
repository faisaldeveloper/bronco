  ...
  <tr>
	...
	<!-- InstanceBeginEditable name="body" -->
          <table width="100%"  border="0" cellspacing="0" cellpadding="2">
            <tr>
              <td width="10%" class="hdng_sandy" align="right"><img src="Images/icon_security_48x48.png" alt="Image CPanel"/></td>
              <td width="90%" valign="middle" class="hdng_sandy">Security</td>
            </tr>
            <tr>
            	<td rowspan="2">&nbsp;</td>
              	<td height="16">Dear <span class="txtBld_grey"><?=$_SESSION['strDsUserName']?></span>, welcome to the <span class="txtBld_grey">security section</span> of DSCMS, by using this you can</td>
            </tr>
            <tr>
              <td height="16">manage the admin users of the site, roles management and change password present here.</td>
            </tr>
            ...
            $nCounter = 0;
			$nSecureLoop=0;
		 	foreach($arrSecurityLinks as $id=>$arrContents)
			{
