...
function ValidateForm(f) 
{
   if(f.txtSate.value == "")
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="2">
	  <tr>
	    <td align="right"><a href="ManageState.php">&lt;&lt;back</a></td>
	    </tr>
	  <tr>
	    <td class="hdng_sandy">Edit State</td>
	    </tr>
	  <tr>
	    <td><form name="frmState" id="frmState" method="post" action="EditStateAction.php" onSubmit="return ValidateForm(this);">
	      <table width="50%" border="0" cellspacing="0" cellpadding="2" align="center">
	        <tr>
	          <td align="right">Name:</td>
	          <td><input type="text" name="txtSate" id="txtSate" value="<?=$strStateName?>"></td>
	          </tr>
	        <tr>
	          <td>&nbsp;</td>
