  ...
  <tr>
	...
	<!-- InstanceBeginEditable name="body" -->
          <table width="98%"  border="0" align="center" cellpadding="2" cellspacing="0">
            <tr>
              <td width="10%" align="right"><img src="Images/icon_CPanel_42x42.png" alt="Image CPanel"/></td>
              <td width="90%" valign="middle" class="hdng_sandy">Content Manager</td>
            </tr>
            <tr>
            	<td rowspan="2">&nbsp;</td>
              	<td height="16">Dear <span class="txtBld_grey"><?=$_SESSION['strDsUserName']?></span>, This is the <span class="txtBld_grey">content management consol</span>, from here you can easily</td>
            </tr>
            <tr>
              <td>manage the content of your website includes: web pages, news, images and customer emails.</td>
            </tr>
            ...
            $nCounter = 0;
			$nSecureLoop=0;
		 	foreach($arrCManagerLinks as $id=>$arrContents)
			{
