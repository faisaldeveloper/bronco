...
Developer:	Syed Salman Sattar Shah.
Owner:		Digital Spinners
Purpose:	Dynamic Image Generation to detected Un Spyed Enterance By SpyWare
*/
   class clsSecurityImage {
      var $oImage;
      var $iWidth;
      var $iHeight;
      var $iNumChars;
      ...
      function clsSecurityImage($iWidth = 200, $iHeight = 50, $iNumChars = 5, $iNumLines = 30) {
         // get parameters
         $this->iWidth = $iWidth;
