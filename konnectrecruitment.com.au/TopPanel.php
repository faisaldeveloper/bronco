   ...
   <td width="100%" height="30" align="left" valign="top" >
	...
	?>
		...
		?>
               ...
               <a href="<?=$resParent->PageUrl?>"><? if($resParent->PageName=='') print "****"; else print $resParent->PageName;?></a>
		<?php 
	...
	<table cellpadding="2" cellspacing="0" width="100%">
	  ...
	  ?>
			...
			<div style="display:absolute;visibility:visible;" onMouseOver="MM_showHideLayers('TOPDIV<?=$nParentId?>','','show')" onMouseOut="MM_showHideLayers('TOPDIV<?=$nParentId?>','','hide')">
				<a href="<?=$rowLeftPanel->PageUrl?>"><? if($rowLeftPanel->PageName=='') print "****"; else print $rowLeftPanel->PageName;?></a><br>
				...
				<table cellpadding="2" cellspacing="2" class="topsubpanel" width="100%">
					...
					?>
							<td nowrap align="left"><a href="<?=$rowSubPage->PageUrl?>"><? print "=>"; if($rowSubPage->PageName=='') print "****"; else print $rowSubPage->PageName;?></a><?=$nWidth?></td>
					<?
