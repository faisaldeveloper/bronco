...
/*		array (
	...
	else // For local Server
	{
		$Path = "/CMS_Projects/CMSExpress/Konnect/Script";
	}
	...
	$cfg['ilibs'] = array (																// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions	
		array (																		
			'value'   	=> $Path.'/WYSIWYG/image1/',												
			'text'    	=> 'Site Pictures',
		),
		array (
			'value'   	=> $Path.'/WYSIWYG/image2/', 				
			'text'    	=> 'Gallery',
		),	
	);
	//-------------------------------------------------------------------------
	...
	$cfg['ilibs_dir'] 	   = array($Path.'/WYSIWYG/image1/');						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
