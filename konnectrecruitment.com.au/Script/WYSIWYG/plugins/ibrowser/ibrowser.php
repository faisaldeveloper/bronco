...
// ============================================================
	function insertImage() {
		...
		if (!args.action) { // if not popup	mode, check whether there is a valid image selected		
			...
			var newarg =  (formObj.pr_src.value) ? (formObj.pr_src.value) : '';
			args.src = (formObj.pr_src.value) ? (formObj.pr_src.value) : '';	
			
			if ('<?php echo $cfg['furl']; ?>' == true) { // create full url incl. e.g. http://localhost....
				newarg = newarg.replace("Script/WYSIWYG/image1/","sImage.php?id=");
				args.src = '<?php echo $cfg['base_url']; ?>' + newarg;				
			}
...
<div id="infoDiv" class="hideit">
  <div>
    ...
    <span id="inf_cwidth"> </span>  </div>
  <div>
    <label><?php echo $l->m('in_029'); ?>:</label>
    <span id="inf_cheight"> </span>  </div>
  <div>
    <label><?php echo $l->m('in_030'); ?>:</label>
    <span id="inf_ctype"> </span>  </div>
  <div>
    <label><?php echo $l->m('in_031'); ?>:</label>
    <span id="inf_csize"> </span>  </div>
  <div>
    <label><?php echo $l->m('in_033'); ?>:</label>
    <span id="inf_ccdate"> </span>  </div>
  <div>
    <label><?php echo $l->m('in_034'); ?>:</label>
    <span id="inf_cmdate"> </span>  </div>
</div>
<form id="iBrowser" name="iBrowser" method="post" action="scripts/rfiles.php" enctype="multipart/form-data" target="inSelFrame">
  ...
  <div id="outerDivWrap">
    <div class="headerDiv">
      <?php echo "Image Browser"; ?>
    </div>
    <div class="brdPad">
      <!- MAIN MENU --------------------------------------------------------- -->
      <div id="menuDivWrap">
        <div class="headerDiv">
          <?php echo $l->m('im_003'); ?>        </div>
        <div class="brdPad">
          <div id="menuDiv">
            <div id="menuBarDiv" >
              <ul>
